 ...
 */
- (instancetype)initWithType:(JHImageButtonType)type AndMarginArr:(NSArray *)arr handler:(tapHandler)handler{
    self = [super init];
    if (self) {
        _marginArr = arr;
        _type = type;
...
- (void)setLeft{
    [_topOrLeftView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        if (_marginTopOrLeft != JHImageButtonDefaultUnSetMargin) {
            ...
            make.width.mas_equalTo(_bottomOrRightView.width);
        }
    }];
...
- (void)setBottom{
    ...
    [_topOrLeftView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        if (_marginTopOrLeft != JHImageButtonDefaultUnSetMargin) {
            ...
            make.height.mas_equalTo(_bottomOrRightView.height);
        }
    }];
...
- (void)setNormalBackgroundImage:(UIImage *)normalBackgroundImage AndHighLightBackgroundImage:(UIImage *)highLightBackgroundImage{
    [self setNormalBackgroundImage:normalBackgroundImage AndHighLightBackgroundImage:highLightBackgroundImage
